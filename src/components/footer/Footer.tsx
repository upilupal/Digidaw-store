...
const Footer = () => {
  return (
    <footer className="bg-primary h-36 md:h-fit mt-auto">
      <div className="text-secondary container mx-auto p-4">
        <div className="flex md:flex-row flex-col gap-2 items-center justify-between py-2">
          <h1 className="md:text-2xl text-xl font-bold">DigiDaw</h1>
          <p className="text-xs md:text-md">
            &copy; {new Date().getFullYear()} Naufal Hanif Cipta Darmara, Inc. All rights reserved
          </p>
