...
import SelectColors from "@/components/inputs/SelectColors";
...
const AddProductForm = () => {
  ...
  return (
    <>
      ...
      <InputForm id="price" label="Price" disabled={isLoading} register={register} errors={errors} type="number" required />
      <InputForm id="brand" label="Brand" disabled={isLoading} register={register} errors={errors} required />
      <TextAreaForm id="description" label="Description" disabled={isLoading} register={register} errors={errors} required />
      ...
      <div className="w-full font-medium">
        ...
        <div className="w-full flex flex-col flex-wrap gap-4 mt-6">
          <div className="">
            <div className="font-bold">Select the available product colors and upload the images.</div>
      ...
      <Button onClick={handleSubmit(onSubmit)}>{isLoading ? "Loading..." : "Add Product"}</Button>
    </>
  );
};
